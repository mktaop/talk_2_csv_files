...
# -- If you have more than one file that you want to use, then make sure to include metadata from all of the files in the following json like string --
schema2 = """{
  "table": [
    {
      "table_name": "loans",
      "schema": [
        ...
        },
        {
          "name": "terms",
          "type": "INTEGER",
          "description": "terms of the loan in number of days"
        },
        {
          "name": "effective_date",
          "type": "DATE",
          "description": "date when the loan was booked or became effective"
        },
        {
          "name": "due_date",
          "type": "DATE",
        ...
        },
        {
          "name": "education",
          "type": "STRING",
          "description": "education level of the borrower"
        },
        {
          "name": "Gender",
          "type": "STRING",
